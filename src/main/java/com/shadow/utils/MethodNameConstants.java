...
public class MethodNameConstants {
    ...
    public static String METHOD_NAME_GETRESULT = "getResult";
    public static String METHOD_NAME_ITERATOR = "iterator";
    public static String METHOD_NAME_HASNEXT = "hasNext";
    public static String METHOD_NAME_NEXT = "next";
    public static String METHOD_NAME_GETTASK = "getTask";
    ...
    public static String METHOD_NAME_GETNAME = "getName";
    public static String METHOD_NAME_GETMETHOD = "getMethod";
