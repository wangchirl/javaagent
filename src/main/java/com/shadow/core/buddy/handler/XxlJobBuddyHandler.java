...
public class XxlJobBuddyHandler extends AbstractBuddyHandler {
    ...
    public void setThreadLocalMethodBody(MethodVisitor methodVisitor) {
        ...
        methodVisitor.visitLdcInsn(Type.getType(XxlConstants.XXL_JOB_EXECUTOR_TYPE.getDescriptor()));
        ...
        methodVisitor.visitTypeInsn(CHECKCAST, XxlConstants.XXL_JOB_EXECUTOR_TYPE.getInternalName());
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_4);
        methodVisitor.visitLdcInsn(Type.getType(XxlConstants.XXL_JOB_EXECUTOR_TYPE.getDescriptor()));
        methodVisitor.visitLdcInsn(XxlConstants.JOB_HANDLER_REPOSITORY);
        ...
        methodVisitor.visitTypeInsn(CHECKCAST, XxlConstants.XXL_JOB_HANDLER_TYPE.getInternalName());
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_7);
        methodVisitor.visitVarInsn(ALOAD, IndexConstants.INDEX_7);
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, XxlConstants.XXL_JOB_HANDLER_TYPE.getInternalName(), MethodNameConstants.METHOD_NAME_EXECUTE, BaseConstants.V_, false);
        ...
        methodVisitor.visitLdcInsn(XxlConstants.XXL_SUCCESS);
