...
public class SpringJobBuddyHandler extends AbstractBuddyHandler {
    ...
    public void setThreadLocalMethodBody(MethodVisitor methodVisitor) {
        ...
        methodVisitor.visitLdcInsn(Type.getType(SpringConstants.SPRING_SCHEDULED_ANNOTATION_BEAN_POSTPROCESSOR_TYPE.getDescriptor()));
        ...
        methodVisitor.visitTypeInsn(CHECKCAST, SpringConstants.SPRING_SCHEDULED_ANNOTATION_BEAN_POSTPROCESSOR_TYPE.getInternalName());
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_4);
        methodVisitor.visitVarInsn(ALOAD, IndexConstants.INDEX_4);
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, SpringConstants.SPRING_SCHEDULED_ANNOTATION_BEAN_POSTPROCESSOR_TYPE.getInternalName(), MethodNameConstants.METHOD_NAME_GETSCHEDULEDTASKS, BaseConstants.SET_, false);
        ...
        methodVisitor.visitTypeInsn(CHECKCAST, SpringConstants.SPRING_SCHEDULED_TASK_TYPE.getInternalName());
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_7);
        methodVisitor.visitVarInsn(ALOAD, IndexConstants.INDEX_7);
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, SpringConstants.SPRING_SCHEDULED_TASK_TYPE.getInternalName(), MethodNameConstants.METHOD_NAME_GETTASK, SpringConstants.TASK_, false);
        ...
        methodVisitor.visitTypeInsn(CHECKCAST, SpringConstants.SPRING_SCHEDULED_METHOD_RUNNABLE_TYPE.getInternalName());
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_9);
        methodVisitor.visitVarInsn(ALOAD, IndexConstants.INDEX_9);
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, SpringConstants.SPRING_SCHEDULED_METHOD_RUNNABLE_TYPE.getInternalName(), MethodNameConstants.METHOD_NAME_GETMETHOD, BaseConstants.REFLECT_METHOD_, false);
        ...
        methodVisitor.visitVarInsn(ALOAD, IndexConstants.INDEX_9);
        methodVisitor.visitMethodInsn(INVOKEVIRTUAL, SpringConstants.SPRING_SCHEDULED_METHOD_RUNNABLE_TYPE.getInternalName(), MethodNameConstants.METHOD_NAME_RUN, BaseConstants.V_, false);
        methodVisitor.visitJumpInsn(GOTO, label7);
        methodVisitor.visitLabel(label8);
        methodVisitor.visitJumpInsn(GOTO, label6);
        methodVisitor.visitLabel(label7);
        methodVisitor.visitLdcInsn(SpringConstants.SPRING_SUCCESS);
        methodVisitor.visitVarInsn(ASTORE, IndexConstants.INDEX_6);
